    ...
    <Box>
        ...
        <Box bg="pink.500" color="white" h="160px">
            ...
            <Flex marginTop="15px" gap="5px" justifyContent="center">
                <Button onClick={()=>navigate("/product")} h="50px" w="22%" bg="blueviolet">SHOP ALL THE DEALS</Button>
                <Button  onClick={()=>navigate("/product")} h="50px" w="22%" bg="blueviolet">SHOP BEST SELLERS</Button>
            </Flex>
        </Box>
        ...
        <Box className='firstTextRel'>
            ...
            <Button onClick={()=>navigate("/product")} marginTop="20px" w="45%" color="white" bg="blue.600">SHOP NOW</Button>
        </Box>
        <Box className='firstTextRel2'>
            ...
            <Button onClick={()=>navigate("/product")} marginTop="20px" w="15%" color="white" bg="blue.600">SHOP NOW</Button>
        </Box>
        ...
        <Box h="870px" marginTop={10} bg="rgb(58,42,124)">
            <Box>
                ...
                <br />
                <Button onClick={()=>navigate("/product")} w="30%" color="white" variant='outline'>SHOP ALL AMAZING DEALS</Button>
            </Box>
            ...
            <Box className='secondRelText1'>
                ...
                <Button onClick={()=>navigate("/product")} marginTop="20px" w="40%" color="rgb(58,42,124)" bg="white">SHOP NOW</Button>
            </Box>
            <Box className='secondRelText2'>
                <Text fontWeight={600} fontSize="25px" color="white" fontStyle="italic" >Now</Text>
                <Box display="inline-flex"><Text marginTop="-10px"  fontWeight={600} fontSize="55px" color="white" >$</Text><Text fontWeight={700} marginTop="-35px" fontSize="95px" color="white">18</Text></Box>
                <Text marginTop="-15px" fontWeight={400} color="white" fontSize="25px">WAS $29.50</Text>
                <Button onClick={()=>navigate("/product")} marginTop="20px" w="12%" color="rgb(58,42,124)" bg="white">SHOP NOW</Button>
            </Box>
            ...
            <Box className='secondRelText4'>
                ...
                <Box display="inline-flex"><Text marginTop="-10px"  fontWeight={600} fontSize="55px" color="white" >$</Text><Text fontWeight={700} marginTop="-35px" fontSize="95px" color="white">18</Text></Box>
                <Text marginTop="-15px" fontWeight={400} color="white" fontSize="25px">WAS $29.50</Text>
                <Button onClick={()=>navigate("/product")} marginTop="20px" w="15%" color="rgb(58,42,124)" bg="white">SHOP NOW</Button>
            </Box>
        </Box>
